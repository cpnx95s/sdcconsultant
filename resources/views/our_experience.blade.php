...
<body>
  ...
  <div id="fullpage">
    <div class="section" data-parallax="scroll" data-image-src="upload/banner3.jpg">
        ...
        <div class="container">
          ...
          @foreach ($row as $row)
                <div class="col-md-6 mb-4">
                 <a href="{{url('experience-detail/'.$row->id)}}" class="item-exp" title="{{$row->name}}">
                  <div class="box-img">
                    <img class="w-100 img-fluid" src="{{$row->image}}" alt="">
                  </div>
