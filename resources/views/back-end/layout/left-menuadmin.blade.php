...
<ul class="c-sidebar-nav">
    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{url("adminwebpanel/")}}"><i class="c-sidebar-nav-icon fas fa-tachometer-alt fa-fw"></i>Dashboard<span class="badge badge-info">NEW</span></a></li>
    ...
    @endforeach
    @php($menu = \App\MenuModel::where(['position'=>'mainadmin','status'=>'off'])->orderBy('sort')->get())
    @foreach($menu as $i => $m)
        @php($second = \App\MenuModel::where('_id',$m->id)->get())  
        <li class="c-sidebar-nav-item @if($second) c-sidebar-nav-dropdown @endif">
            <a class="c-sidebar-nav-link @if(count($second)>0) c-sidebar-nav-dropdown-toggle @endif" href="adminwebpanel{!!$m->url!!}"><i class="c-sidebar-nav-icon {!!$m->icon!!}"></i> {{$m->name}}</a>
    ...
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown">
        ...
        <ul class="c-sidebar-nav-dropdown-items">
            ...
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="adminwebpanel/menu"><span class="c-sidebar-nav-icon"></span> Menu</a></li>
        </ul>
    </li>
