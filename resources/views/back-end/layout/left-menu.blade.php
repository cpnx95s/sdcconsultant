...
<ul class="c-sidebar-nav">
    ...
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown">
        ...
        <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="webpanel/user"><span class="c-sidebar-nav-icon"></span> User</a></li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="webpanel/menu"><span class="c-sidebar-nav-icon"></span> Menu</a></li>
        </ul>
    </li>    
