                    ...
                    <table class="table table-striped no-footer table-res" id="sorted_table"
                        ...
                        <thead>
                            <tr role="">
                                ...
                                <th scope="col">STAND_BY_DATE</th>
                                <th scope="col">STAND_BY_TIME</th>
                                <th scope="col">START_DATE</th>
                                <th scope="col">START_TIME</th>
                                <th scope="col">ARRIVED_SCHEDULE_DATE</th>
                                <th scope="col">ARRIVED_SCHEDULE_TIME</th>
                                <th scope="col">TOTAL_HOUR</th>
                                <th scope="col">MONITOR_STAFF</th>
                                <th scope="col">REMARK</th>
                                <th scope="col">STATUS_PLAN</th>
                                <th scope="col">CANCEL_REASON</th>
