            ...
            <form id="formEdit" method="post" action="" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <span class="breadcrumb-item "><a href="{{url("$segment")}}">ผลงานของเรา / Project</a></span>
                                ...
                                <div class="tab-pane active" id="th" role="tabpanel">
                                    ...
                                    <div class="row" style="margin-bottom:5px;">
                                        <div class="col-md-12">
                                            ...
                                            <input id="category" name="category" type="text" class="form-control" value="" autocomplete="off" placeholder="ประเภทของผลงาน">
                                        </div>
                                    </div>
