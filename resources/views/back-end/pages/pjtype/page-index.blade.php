            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">                
                    <div class="card-header"> 
                        ...
                        <a href="{{url("$segment")}}" class="card-header-action">จัดการประเภทโปรเจ็ค</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xs-12 mb-4">
                                    ...
                                    <div class="input-group">                                        
                                        <input type="text" name="keyword" class="form-control" id="search" value="{{Request::get('keyword')}}" placeholder="ชื่อประเภทโปรเจ็ค">
                            ...
                            <table  class="table table-striped no-footer table-res" id="sorted_table" style="border-collapse: collapse !important">
                                <thead>
                                    <tr role="">
                                        ...
                                        <th width="60%">ชื่อประเภทโปรเจ็ค</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach($rows as $key => $row)
                                        ...
                                        <tr role="row" class="odd" data-row="{{$key+1}}" data-id="{{$row->id}}">
                                            ...
                                            <td data-label="ชื่อประเภทโปรเจ็ค">
                                                {{$row->name}}
                                            </td>
