            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">                
                    <div class="card-header"> 
                        ...
                        <a href="{{url("$segment")}}" class="card-header-action">Project Type</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xs-12 mb-4">
                                    ...
                                    <div class="input-group">                                        
                                        <input type="text" name="keyword" class="form-control" id="search" value="{{Request::get('keyword')}}" placeholder="Project Type">
