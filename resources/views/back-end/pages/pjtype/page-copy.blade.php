<div class="fade-in">
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <form id="signupForm" method="GET" action="{{url("$segment/pjtype/copy/{id}/create")}}" enctype="multipart/form-data">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="nav-tabs-boxed">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#th" role="tab" aria-controls="th">ประเภทโปรเจ็ค </a></li>
                            </ul>
