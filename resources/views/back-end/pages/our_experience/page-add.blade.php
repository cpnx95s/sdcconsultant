            ...
            <form id="formEdit" method="post" action="" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <span class="breadcrumb-item "><a href="{{url("$segment")}}">Our Experience</a></span>
                                ...
                                <div class="tab-pane active" id="th" role="tabpanel">
                                    ...
                                    <div class="row" style="margin-bottom:5px;">
                                        <div class="col-md-12">
                                            ...
                                            <input id="short_detail" name="short_detail" type="text" class="form-control" value="" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="row" style="margin-bottom:5px;">
                                            <div class="col-md-12">
                                                <label>Location</label><span style="color:red">*</span><br />
                                                <input id="location" name="location" type="text" class="form-control" value="" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="row" style="margin-bottom:5px;">
                                                <div class="col-md-12">
                                                    <label>Project owner</label><span style="color:red">*</span><br />
                                                    <input id="project_owner" name="project_owner" type="text" class="form-control" value="" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom:5px;">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-12">
                                                                ...
                                                                <input id="duration_s" name="duration_s" type="date" class="form-control" value="" autocomplete="off">
                                                                <label>End the project</label><span style="color:red">*</span><br />
                                                                <input id="duration_f" name="duration_f" type="date" class="form-control" value="" autocomplete="off">
                                    ...
                                    <div class="row" style="margin-bottom:5px;">
                                        <div class="col-md-12">
                                            ...
                                            <textarea id="" name="detail" class="contents tiny"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
