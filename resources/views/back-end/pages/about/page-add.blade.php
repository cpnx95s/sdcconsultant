            ...
            <form id="formEดdit" method="post" action="" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <span class="breadcrumb-item "><a href="{{url("$segment")}}">เกี่ยวกับเรา / About</a></span>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="th" role="tabpanel">                               
                                    ...
                                    <div class="row" style="margin-bottom:5px;">
                                        <div class="col-md-12">
                                            <label>ข้อความต้อนรับ</label><span style="color:red">*</span><br />
                                            <input id="word" name="word" type="text" class="form-control" value="" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin-bottom:5px;">
                                        <div class="col-md-12">
                                            <label>รายละเอียดย่อย</label><span style="color:red">*</span><br />
