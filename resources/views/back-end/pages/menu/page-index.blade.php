                                    ...
                                    @foreach($rows as $key => $row)
                                        ...
                                        <tr role="row" class="odd" data-row="{{$key+1}}" data-id="{{$row->id}}">
                                            ...
                                            <td data-label="Name of menu">
                                                ...
                                                <span class="badge badge-success" type="button" data-toggle="collapse" data-target=".multi-collapse{{$key}}" aria-expanded="false" aria-controls="col2{{$key}} col3{{$key}} col4{{$key}} col5{{$key}}">Secondary</span>
                                                @endif    
