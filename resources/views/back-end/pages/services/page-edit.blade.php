            ...
            <form id="signupForm" method="post" action="" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <span class="breadcrumb-item "><a href="{{url("$segment")}}"> Services </a></span>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="th" role="tabpanel">
                                    ...
                                    <div class="row" style="margin-bottom:5px;">
                                        <div class="col-md-12">
                                            <label>รายละเอียดหัวข้อ</label><span style="color:red">*</span><br />
                                            <textarea id="" name="list_detail" class="form-control" >{{$row->list_detail}}</textarea>
