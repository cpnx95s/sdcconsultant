                                ...
                                <div class="tab-pane active" id="th" role="tabpanel">
                                    ...
                                    <div class="row" style="margin-bottom:5px;">
                                        <div class="col-md-6">
                                            ...
                                            <input id="link" name="link" type="text" class="form-control" value="{{$row->link}}" autocomplete="off" placeholder="ลิงค์เว็บลูกค้า ไม่จำเป็นต้องใส่ ตัวอย่าง (https:://www.ชื่อเว็บ.com)">
                                        </div>
                                    </div>
