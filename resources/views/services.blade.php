...
<body>
  ...
  <div id="fullpage">
    <div class="section" data-parallax="scroll" data-image-src="upload/banner2.jpg">
      ...
      <div id="d-body" class="body">
        <div class="container">
          ...
          <div class="row box-service">
            ...
            <div class="col-lg-6 box-service p">
              <ul class="mt-lg-4 pl-lg-5">
                <li>Provision of business information to potential  Clients/Investors.</li> 
                <li>Project identification for Investment Companies.</li> 
                <li>Pre-feasibility and feasibility studies. </li>
                <li>Project cost indication and cash flow forecasts.</li> 
                <li>Project planning and design. </li>
                <li>Project monitoring and evaluation.</li> 
              </ul>
            </div>
            <div class="col-md-6 pl-lg-0">
              <img class="w-100 img-fluid" src="upload/service01.jpg" alt="">
            </div>
            <div class="col-md-6 pr-lg-0">
              <img class="w-100 img-fluid" src="upload/service02.jpg" alt="">
            </div>
            <div class="col-lg-6 box-service">
              <ul class="mt-4 pl-lg-5">
                <li>Topography survey. </li>
                <li>Marketing survey. </li>
                <li>Project management. </li>
                <li>Construction supervision </li>
                <li>Preliminary and detailed architectural and engineering designs.</li> 
                <li>Energy Consulting Services.</li>   
              </ul>
