...
<body>
  ...
  <div id="fullpage">
    <div  class="section" data-parallax="scroll" data-image-src="upload/banner.jpg">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4">
              ...
              <h2>{{$row->word}}<span> {{$row->company_name}}</span></h2>
              </div>
            </div>
            <div class="col-lg-8 pt-4">
              <p>{{$row->short_detail}}</p>
              <p>
                <b>{{$row->company_name}}</b>{!!$row->detail!!}</p>
            </div>
          </div>
          <div class="box-img pl-lg-5">
            <div class="row">
                        ...
                        <div class="view-seventh mb-4">
                            <a href="{{$gallery->image}}" class="b-link-stripe b-animate-go thickbox" title="{{$row->name}}">
                                <div class="box-gallery">
                                    <div class="bg-img">
                                        <img class="img-fluid" src="{{$gallery->image}}" alt="{{$row->name}}">
                                    </div>
