...
<body>
  ...
  <div id="fullpage">
    <div class="section" data-parallax="scroll" data-image-src="upload/banner1.jpg">
      ...
      <!-- //Page container -->
      <div class="name-in">
        <h1>Fields of <br>Specialization
        </h1>
      </div>
    ...
    <div id="specialization-section" class="section" >
      <div id="d-body" class="body">
        <div class="container">


      <h3 class="mb-5">Professionals in various fields are recruited to perform the following tasks:</h3>



      <div class="row box-specialization">
        ...
        <div class="col-lg-6">
         ...
         @endif
          ...
          <ul>
            ...
            <li>Domestic and public buildings</li> 
          </ul>
          ...
          <ul>
            ...
            <li>Plumbing for residential, commercial and  industrial buildings</li> 
          </ul>
          ...
          <ul>
            <li>Building and plant services</li>   
            <li>Electrical systems for housing projects</li>   
            <li>Secondary power distribution systems</li> 
          </ul>

          <h4>SANITARY AND WATER SUPPLY  </h4>  
          <ul>
            <li>Water treatment</li>   
            <li>Water supply distribution networks</li>   
        ...
        <div class="col-lg-6">
          ...
          <h4>AGRICULTURE AND AGRO-INDUSTRY</h4>
          <ul>
            <li>Plantation establishment (planning, design, construction 
            supervision and management)</li>
            <li>Ranch establishment  </li>
            <li>Crop and animal production</li>  
            <li>Irrigation and drainage system </li>  
            <li>Landscape maintenance and management</li>   
            <li>Aquaculture  </li>
            <li>Seed production  </li>
            <li>Agricultural economics and marketing</li>   
            <li>Systems analysis   </li>
            <li>Agro-industrial plant layout and design</li>   
          ...
          <ul>
            ...
            <li>Cost control   </li>
            <li>Provision of all related engineering disciplines </li>
          </ul>


          <h4>ENERGY  CONSULTING SERVICES</h4>
          <ul> 
            <li>Energy Audit  and  Analysis  </li> 
            <li>Energy Planning  and  Management   </li>
            <li>Energy Efficient  Designs </li>
            <li>Energy Conservation Equipment and Machine,     
            Evaluation and Installation Supervision </li>
          </ul>
