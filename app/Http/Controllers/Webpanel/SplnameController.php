...
class SplnameController extends Controller
{
    ...
    {   
        ...
        return view("$this->prefix.pages.splname.staffindex", [
            'css' => ['back-end/css/table-responsive.css'],
            'js' => [
                ['type' => "text/javascript", 'src' => "back-end/js/jquery.min.js", 'class' => "view-script"],
                ["src" => "back-end/js/table-dragger.min.js"],
            ...
            'folder' => 'splname',
            'page' => 'index',
            'segment' => "$this->segmentst/splname",
            'rows' => $rows
        ]);
    }
    ...
    public function staffstore(Request $request)
    {
        ...
        if ($data->save()) {
            ...
            return view("$this->prefix/alert/sweet/success", ['url' => url("$this->segmentst/splname")]);
        } else {
            return view("$this->prefix/alert/sweet/error", ['url' => url("$this->segmentst/splname/create")]);
        }
    }
    ...
    public function staffcopystore(Request $request, $id)
    {
        ...
        if ($data->save()) {
            ...
            return view("$this->prefix/alert/sweet/error", ['url' => url("$this->segmentst/splname/copy")]);
        }
    }
