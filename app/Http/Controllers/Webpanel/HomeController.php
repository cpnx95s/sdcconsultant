...
class HomeController extends Controller
{
    ...
    public function Chartjs()
    {
        ...
        //onprocess Pending
        $Total_Req_E1 = $FLH_LH_E1 + $FLH_Del_E1 + $KEY_Del_E1 + $BES_LH_E1 + $SHOP_FM_E1 + $JT_LH_E1 + $SCG_LH_E1 + $DHLBigC_DC_E1 + $Office_DC_E1 + $KLine_LH_E1+$SCGL_DC_E1;
        //fullfill Active
        $Total_Req_E2 = $FLH_LH_E2 + $FLH_Del_E2 + $KEY_Del_E2 + $BES_LH_E2 + $SHOP_FM_E2 + $JT_LH_E2 + $SCG_LH_E2 + $DHLBigC_DC_E2 + $Office_DC_E2 + $KLine_LH_E2+$SCGL_DC_E2;
    ...
    public function staffsearchChart(Request $request)
    {
        $mytime =  $request->input('DATE');
        if ($mytime == '') {
            $mytime = Carbon::now()->format('Y-m-d');
