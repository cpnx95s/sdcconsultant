...
class TsptypeController extends Controller
{
   ...
   public function adminindex(Request $request)
   {
       ...
       return view("$this->prefix.pages.$this->folder.adminindex", [
           ...
           'folder' => 'tsptype',
           'page' => 'index',
           'segment' => "$this->segmentad/tsptype",
           'rows' => $rows
       ]);
   }
   ...
   public function adminstore(Request $request)
   {
       ...
       if ($data->save()) {
           ...
           return view("$this->prefix/alert/sweet/success", ['url' => url("$this->segmentad/tsptype")]);
       } else {
           return view("$this->prefix/alert/sweet/error", ['url' => url("$this->segmentad/tsptype/create")]);
       }
   }
