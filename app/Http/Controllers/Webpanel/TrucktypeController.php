...
class TrucktypeController extends Controller
{
    ...
    public function staffindex(Request $request)
    {
        ...
        return view("$this->prefix.pages.trucktype.staffindex", [
            'css' => ['back-end/css/table-responsive.css'],
            'js' => [
                ['type' => "text/javascript", 'src' => "back-end/js/jquery.min.js", 'class' => "view-script"],
                ["src" => "back-end/js/table-dragger.min.js"],
            ...
            'folder' => 'trucktype',
            'page' => 'index',
            'segment' => "$this->segmentst/trucktype",
            'rows' => $rows
        ]);
    }
    ...
    public function staffstore(Request $request)
    {
        ...
        if ($data->save()) {
            TrucktypeModel::where('id', '!=', $data->id)->increment('sort');
            return view("$this->prefix/alert/sweet/success", ['url' => url("$this->segmentst/trucktype")]);
        } else {
    ...
    public function staffclone(Request $request, $id)
    {
        //$data = TrucktypeModel::find($id);
        $data = new TrucktypeModel;
        $data->id = "NULL";
        ...
        if ($data->save()) {
            ...
            return view("$this->prefix/alert/sweet/error", ['url' => url("$this->segmentst/trucktype/copy")]);
        }
    }
