...
$moxieManagerConfig['general.plugins'] = 'Ftp';
...
// Filesystem
$moxieManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"]."/public/moxieupload";  ///webroot/uploads';
// $moxieManagerConfig['filesystem.rootpath'] = "Files=".$_SERVER["DOCUMENT_ROOT"]."/upload;Upload=ftp://Files";  ///webroot/uploads';
...
$moxieManagerConfig['authenticator'] = false;
...
$moxieManagerConfig['ftp.accounts'] = array(
	'Files' => array(
		...
		'port' => '8998',
		'user' => 'cwco55',
		'password' => 'mfkYHN3k}jF4',
		'rootpath' => '/public_html/maingan/public/moxieupload',
		'wwwroot' => '/public_html/maingan/public/moxieupload',
		'passive' => true
	)
);
